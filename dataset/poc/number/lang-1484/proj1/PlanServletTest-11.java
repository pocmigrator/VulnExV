...
public class PlanServletTest {
    ...
    public void testVulnerabilityTriggered() throws ServletException, IOException {
        ...
        when(req.getServletPath()).thenReturn("/admin/plan");
        ...
        // Create a PlanServlet object and call the doGet method
        PlanServlet servlet = new PlanServlet();
